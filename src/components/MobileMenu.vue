  ...
  <div class="mb-wrap">
    ...
    <div class="mb-sns">
      <ul class="mb-sns-list clearfix">
        ...
        <li><a href="#"><img :src="require('@/assets/images/sns_insta.png')" alt="blog"></a></li>
        <li><a href="#"><img :src="require('@/assets/images/sns_facebook.png')" alt="blog"></a></li>
      </ul>
    </div>
